...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yatiml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13673&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yatiml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yatiml` can be installed with:

```
conda install yatiml
```

It is possible to list all of the versions of `yatiml` available on your platform with:
